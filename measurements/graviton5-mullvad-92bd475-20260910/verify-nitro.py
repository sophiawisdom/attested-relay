...
if mode=='production':
 assert policy['iterations']==43768124 and policy['state']=='warming'
 ...
 assert policy['iterations']==8 and policy['state']=='ready'
 ...
 fetch(record_name);key=out/'diagnostic-epoch.key';native=str(pathlib.Path.cwd()/'target/debug/relay-timelock')
